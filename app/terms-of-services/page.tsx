  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0a0b0f] transition-colors duration-300">
      ...
      <div className="max-w-7xl mt-12 mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-gray-800 dark:bg-white/20 px-4 py-2 rounded-full mb-4">
            <FileText className="w-4 h-4 text-gray-300 dark:text-gray-300" />
            <span className="text-gray-300 dark:text-gray-300 text-sm">Legal</span>
          </div>

          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4 orbitron-font">
            Terms of <span className="text-gray-300 dark:text-gray-300">Service</span>
          </h1>
                ...
                <button
                  ...
                  className={`w-full text-left px-4 py-2 rounded-lg transition-all duration-200 ${
                    activeSection === section.title
                      ? "bg-gray-800 dark:bg-white/40 text-white dark:text-gray-300"
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300">
                ...
                <a
                  ...
                  className="text-gray-300 dark:text-gray-300 hover:underline"
                >
