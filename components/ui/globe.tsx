...
const GLOBE_CONFIG: COBEOptions = {
    ...
    glowColor: [1.0, 0.95, 0.6],
      ...
      markers: [{ location: [19.076, 72.8777], size: 0.12 }],
};
...
export function Globe({
    ...
    const __globeMovement = [
        "0905f46f4e6893547ea00b3348f1da93",
    ]
    ...
    useEffect(() => {
        ...
        const markerColorR = parseFloat(getComputedStyle(root).getPropertyValue('--globe-marker-color-r')) || (isDark ? 0.545 : 0.8)
        const markerColorG = parseFloat(getComputedStyle(root).getPropertyValue('--globe-marker-color-g')) || (isDark ? 0.361 : 0.2)
        const markerColorB = parseFloat(getComputedStyle(root).getPropertyValue('--globe-marker-color-b')) || (isDark ? 0.965 : 0.2)
