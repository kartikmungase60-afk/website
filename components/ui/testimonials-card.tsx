...
export function TestimonialsCard({
    ...
    return (
        <div className={cn("flex items-center justify-center p-8 overflow-hidden", className)}>
            <div
                className="relative grid grid-cols-[1fr] md:grid-cols-[1fr_1fr] md:grid-rows-[auto_auto_auto_auto] gap-x-8 gap-y-2 w-full "
            ...
            >
                ...
                {/* Image Card Stack */}
                <div className="row-start-2 col-start-1 md:row-start-1 row-span-3 relative w-full max-w-[280px] mx-auto aspect-square">
                            ...
                            return (
                                <motion.div
                                    ...
                                    animate={
                                        isActive
                                            ? {
                                                x: [offset * 15, direction === 1 ? -120 : 120, 0],
                ...
                {/* Text Area */}
                <div className="col-start-1 md:col-start-2 md:row-start-2 relative h-[140px] w-full">
                    <AnimatePresence>
                        <motion.div
                            key={activeItem.id}
                ...
                {showNavigation && items.length > 1 && (
                    <div className="col-start-1 md:col-span-2 md:row-start-4 flex justify-center gap-4 mt-8 z-20 relative">
                        <button
